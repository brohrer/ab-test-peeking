...
def main():
    ...
    print('cv', cumulative_violation.shape)
    ...
    print('fv', fraction_violations)

    fig, ax = create_violations_axes(np.max(N))
    ax.plot(N, fraction_violations)

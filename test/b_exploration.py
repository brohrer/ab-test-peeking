...
def main():
    ...
    print(
        "corrected crossover",
        np.mean(corrected_crossover),
        np.median(corrected_crossover),
        np.sqrt(np.var(corrected_crossover)),
    )
    print(
        "uncorrected crossover",
        np.mean(uncorrected_crossover),
        np.median(uncorrected_crossover),
        np.sqrt(np.var(uncorrected_crossover)),
    )
    print(
        "corrected filt crossover",
        np.mean(corrected_filt_crossover),
        np.median(corrected_filt_crossover),
        np.sqrt(np.var(corrected_filt_crossover)),
    )
    print(
        "uncorrected filt crossover",
        np.mean(uncorrected_filt_crossover),
        np.median(uncorrected_filt_crossover),
        np.sqrt(np.var(uncorrected_filt_crossover)),
    )
